...
RUN apk add  --no-cache nano \
			   ...
			   php7-pdo_mysql php7-session php7-ctype php7-gd php7-mbstring php7-zip php7-simplexml wget

RUN wget https://github.com/ampache/ampache/releases/download/$RELEASE/ampache-$RELEASE\_all.zip -O ampache.zip
RUN unzip ampache.zip -d /var/www/localhost/htdocs/
