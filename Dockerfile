...
RUN apk add  --no-cache nano \
			   ...
			   php7-pdo_mysql php7-session php7-ctype php7-gd php7-mbstring php7-zip php7-simplexml curl

RUN curl https://github.com/ampache/ampache/releases/download/$RELEASE/ampache-$RELEASE\_all.zip -o /var/www/localhost/htdocs/ampache-$RELEASE_all.zip
