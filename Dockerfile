...
ADD --chown=ampache:ampache https://github.com/ampache/ampache/releases/download/$RELEASE/ampache-$RELEASE\_all.zip ampache.zip
RUN unzip ampache.zip -d /var/www/localhost/htdocs/ && rm /var/www/localhost/htdocs/ampache.zip && rm /var/www/localhost/htdocs/index.html
