...
RUN apk add  --no-cache nano \
			   ...
			   php7-pdo_mysql php7-session php7-ctype php7-gd php7-mbstring php7-zip php7-simplexml ffmpeg && rm /var/www/localhost/htdocs/index.html
...
RUN unzip ampache-$RELEASE\_all.zip -d . && rm /var/www/localhost/htdocs/ampache-$RELEASE\_all.zip && \
    ...
    rm -rf ./lib/vendor/swisnl/jQuery-ContextMeny/documentation/ && \
